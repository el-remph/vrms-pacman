# Generated by ./util/spdx-hack.pl from SPDX list version 3ba09ed
...
our %db = (
  ...
  "\FLiLiQ-P-1.1" => {
    isOsiApproved => 1,
    name => "Licence Libre du Qu\x{e9}bec \x{2013} Permissive version 1.1",
  },
  "\FLiLiQ-R-1.1" => {
    isOsiApproved => 1,
    name => "Licence Libre du Qu\x{e9}bec \x{2013} R\x{e9}ciprocit\x{e9} version 1.1",
  },
  "\FLiLiQ-Rplus-1.1" => {
    isOsiApproved => 1,
    name => "Licence Libre du Qu\x{e9}bec \x{2013} R\x{e9}ciprocit\x{e9} forte version 1.1",
  },
